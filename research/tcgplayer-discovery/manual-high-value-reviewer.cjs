...
class ManualHighValueReviewer {
  ...
  getHighValueUnmatchedCards() {
    ...
    try {
      ...
      console.log('⚠️  Database tables not found. Creating sample high-value cards for demonstration...');
      
      // Sample high-value cards for demonstration
      const sampleCards = [
        {
          id: 'sample-1',
          name: '1999 Pokemon Base Set 1st Edition Holo Charizard #4 PSA 10',
          price: 140000000000, // $14,000 in lamports
          grader: 'PSA',
          grade: '10',
          usdPrice: 14000
        },
        {
          id: 'sample-2',
          name: '1996 Pokemon Japanese Base Set Pikachu #025 PSA 10',
          price: 161000000000, // $16,100 in lamports
          grader: 'PSA',
          grade: '10',
          usdPrice: 16100
        },
        {
          id: 'sample-3',
          name: '2023 Pokemon Japanese SV 151 Charizard ex #223 PSA 10',
          price: 161000000000, // $16,100 in lamports
          grader: 'PSA',
          grade: '10',
          usdPrice: 16100
        ...
        {
          id: 'sample-4',
          name: '2024 Pokemon Japanese SV6 Charizard ex #223 PSA 10',
          price: 140000000000, // $14,000 in lamports
          grader: 'PSA',
          grade: '10',
          usdPrice: 14000
      ...
      console.log(`💰 Found ${sampleCards.length} high-value unmatched cards (sample data):`);
      return sampleCards;
    }
  }
  ...
  findPotentialMatches(phygitalsCard, usdPrice) {
    ...
    try {
      ...
      return [
        {
          id: 'match-1',
          cc_title: '1999 Pokemon Base Set 1st Edition Holo Charizard #4 PSA 10 GEM MINT',
          final_market_value: 15000
        },
        {
          id: 'match-2',
          cc_title: '1999 Pokemon Base Set 1st Edition Holo Charizard #4 PSA 9 MINT',
          final_market_value: 12000
        },
        {
          id: 'match-3',
          cc_title: '1999 Pokemon Base Set Shadowless Holo Charizard #4 PSA 10 GEM MINT',
          final_market_value: 18000
        }
      ];
    }
  }
