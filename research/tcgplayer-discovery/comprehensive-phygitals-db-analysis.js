...
class PhygitalsDbAnalysis {
  ...
  async analyzeAllPhygitalsDbases() {
    ...
    const dbFiles = [
      './phygitals_complete_all.db',
      './phygitals_pokemon_complete.db',
      './phygitals_pokemon_complete_v2.db', 
      './phygitals_mega_harvest.db',
      '../fanatics-collect-discovery/phygitals_pokemon_complete.db'
    ];
